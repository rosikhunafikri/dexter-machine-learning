...
################################# Optional: Magnitude hypothesis ##################################

    # approximators = []
    # approx_net = ContinuousNetwork(1, 4)
    # approx_neuron = ContinuousNeuron(1)
    # approximators.append(approx_net)
    # approximators.append(approx_neuron)
    # m_list = [1, 2, 3, 4, 5, 6, 7, 8, 10, 15, 20, 25, 30, 35, 40, 45, 50, 75, 100]
    ...
    #         # if os.path.exists(os.path.join(fpath,fname)):
    #         #     continue
    #         approx.fit(func, n_updates, x_start, x_end, n_train_datapoints, magnitude=m)
    #         err = eval_approximator(func, approx, x_start, x_end, n_eval_steps, figure_path=fpath, figure_filename=fname)
    #         err_list.append(err)
    #
    #     try:
    ...
    #         print(e)
    #     plt.savefig(os.path.join(fpath, f"mag_hypo_{fname}"))
    #     plt.close()
